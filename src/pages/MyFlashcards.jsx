  ...
  if (!flashcards || flashcards.length == 0) {
    return (
      <div className="text-center text-5xl mt-32 text-red-500 font-bold ">
        No card available!
        <p className="px-4 text-xl mt-5 text-black font-light">
          go to{" "}
          <NavLink to="/" className="underline text-red-500">
            create flashcards
          </NavLink>{" "}
