...
function App() {
  ...
  return (
    <div className=''>
      {/* Heading/Logo  */}
      <h1 className='flex justify-center p-2 my-2'>
        <svg width="16" viewBox="0 0 232 412" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='self-center text-3xl ml-1 head text-white'>
          lashcard Generator
        </div>
